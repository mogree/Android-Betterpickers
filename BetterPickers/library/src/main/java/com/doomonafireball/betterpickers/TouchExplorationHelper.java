...
public abstract class TouchExplorationHelper<T> extends AccessibilityNodeProviderCompat
     ...
     * properties set in {@link #populateNodeForItem(Object, android.support.v4.view.accessibility.AccessibilityNodeInfoCompat)} have changed. </p>
     */
    ...
    /**
     * Performs an accessibility action on the specified item. See {@link android.support.v4.view.accessibility.AccessibilityNodeInfoCompat#performAction(int,
     * android.os.Bundle)}. <p> The helper class automatically handles focus management resulting from {@link
     * android.support.v4.view.accessibility.AccessibilityNodeInfoCompat#ACTION_ACCESSIBILITY_FOCUS} and {@link android.support.v4.view.accessibility.AccessibilityNodeInfoCompat#ACTION_CLEAR_ACCESSIBILITY_FOCUS},
     * so typically a developer only needs to handle actions added manually in the {{@link #populateNodeForItem(Object,
     * android.support.v4.view.accessibility.AccessibilityNodeInfoCompat)} method. </p>
     *
     ...
     * the event text using {@link android.support.v4.view.accessibility.AccessibilityNodeInfoCompat#setText(CharSequence)} or {@link
     * android.support.v4.view.accessibility.AccessibilityNodeInfoCompat#setContentDescription(CharSequence)} </li> <li>set the item's parent-relative bounds
     * using {@link android.support.v4.view.accessibility.AccessibilityNodeInfoCompat#setBoundsInParent(android.graphics.Rect)} </ul>
     *
